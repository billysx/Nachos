...
OpenFile::ReadAt(char *into, int numBytes, int position)
{
    ...
    //printf("%d %d\n",hdr->ByteToSector(firstSector),hdr->ByteToSector(lastSector));
...
OpenFile::WriteAt(char *from, int numBytes, int position)
{
    ...
    DEBUG('f', "%d Writing %d bytes at %d, from file of length %d.\n",
            hdrPos,numBytes, position, fileLength);
...
// read in first and last sector, if they are to be partially modified
    ...
    //printf("---file at %d increase from %d to %d---\n",hdrPos,hdr->size,hdr->size+numBytes);
    hdr->size = hdr->size + numBytes;
